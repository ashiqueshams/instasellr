...
import { Package, ShoppingCart, LayoutDashboard, Settings, LogOut, Menu, X, Layers, Link2, Truck, Send, Star, Megaphone } from "lucide-react";
...
const navItems = [
  ...
  { label: "Referrals", icon: Megaphone, path: "/dashboard/referrals" },
