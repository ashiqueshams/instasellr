      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl p-6 store-shadow space-y-4">
          ...
          <button
            ...
            className="h-11 w-full rounded-lg border border-border bg-background text-foreground font-body font-medium text-sm hover:bg-muted active:scale-[0.98] transition-all disabled:opacity-50 flex items-center justify-center gap-2.5"
          >
